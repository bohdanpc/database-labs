...
def index(request):
	template = loader.get_template('CoolApp/main.html')
	if request.method == 'GET':
		if 'doctors' in request.GET:
			return HttpResponseRedirect('/objects/doctors')
		if 'pacients' in request.GET:
			return HttpResponseRedirect('/objects/persons')
		if 'hospitals' in request.GET:
			return HttpResponseRedirect('/objects/hospitals')
		if 'surveys' in request.GET:
			return HttpResponseRedirect('/objects/surveys')
		if 'logs' in request.GET:
			return HttpResponseRedirect('/objects/log')
		context = []
